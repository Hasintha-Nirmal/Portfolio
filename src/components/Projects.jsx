...
const Projects = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://api.github.com/users/Hasintha-Nirmal/repos?sort=updated&per_page=6')
      .then(res => res.json())
      .then(data => {
        // Filter out if needed, otherwise take top 6
  ...
  return (
    <section className="projects reveal" id="projects">
      <div className="container">
        ...
        <p className="section-subtitle">Automatically fetched from my latest GitHub activity.</p>

        {loading ? (
          <div className="loading-grid">Loading top projects...</div>
        ) : (
